...
// middle ware
app.use(cors({
    origin: ['http://localhost:5173', 'https://car-doctor-10461.web.app', 'https://car-doctor-10461.firebaseapp.com'],
    credentials: true
}));
...
async function run() {
    try {
        ...
        app.patch('/bookings/:id', async (req, res) => {
            ...
            const result = await bookingCollection.updateOne(query, booking);
            res.send(result);
        })
